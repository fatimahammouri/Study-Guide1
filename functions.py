...
def sign_and_parity(integer):
    ...
    info_list =[]
    info_list.extend([first_info, second_info])
...
def write_letter(name, job_title, sender_name):
    print(f"Dear {full_title(name, job_title)}, I think you are amazing! Sincerely, {sender_name}")
